                        ...
                        <div class="temp">
                            ...
                            <div class="minmax">
                                <div class="min">
                                    ...
                                    {{ w.main.temp_min.toFixed(0) }}°C
                                </div>
                                <div class="max">
                                    <i class="fa-solid fa-arrow-up"></i>
                                    {{ w.main.temp_max.toFixed(0) }}°C
                                </div>
                            </div>
                        </div>
  ...
  methods: {
    remove (city) {
      ...
      this.weathers = this.weathers.filter(
        (w) => !w.name.toLowerCase().includes(city.toLowerCase())
      )
    }
  },
  computed: {
    weathersFilter () {
      ...
      return this.weathers.filter((w) =>
        w.name.toLowerCase().includes(this.city.toLowerCase())
      )
    }
  },
  beforeUnmount () {
